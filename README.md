...
**TOTAL:** ~677 GB  
 ...
 > Wabbajack requires around 40 GB of space for temporary and working files during the installation. The total size after installation is done is closer to 637 GB.
...
Prior to installing Revenant, please complete the following steps:
 ...
 1. Install [Visual C++ x64](https://aka.ms/vs/17/release/vc_redist.x64.exe) & [.Net Runtime 8.X.X desktop x64](https://dotnet.microsoft.com/en-us/download/dotnet/thank-you/runtime-desktop-8.0.5-windows-x64-installer).
...
#### Setting Shader Cache Size (NVIDIA Graphics Cards Only)
 ...
 6. You may exit out of the application.
    ...
    >   [Example image](https://raw.githubusercontent.com/iAmMe27/Tahrovin/main/img/ShaderCache.png)
...
2. Make sure `Show Unofficial Lists` is checked on top-right.
